...
int main()
{
    ...
    // ------------------------------------
    Shader ourShader("textureloop_dir/shader.vs", "textureloop_dir/shader.fs");
    ...
    auto filepaths = getImageFilenames(image_path);
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        auto data = stbi_load(filepaths.at(currentImageIndex).c_str(),
                              &width,
                              &height,
                              &nrChannels,
                              0);
        currentImageIndex++;
        if (currentImageIndex >= filepaths.size()) {
            currentImageIndex = 0;
        }
        ...
        if (data) {
            ...
            std::cout << "Failed to load texture: " << filepaths.at(currentImageIndex) << std::endl;
        }
